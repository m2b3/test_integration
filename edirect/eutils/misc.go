...
// CompareNumericStringKeys is called by slices.Sort{ed}Func to sort strings containing numbers
func CompareNumericStringKeys(i, j string) int {
	...
	// same length allows comparison of numeric values without expensive string-to-integer conversion
...
func FixSpecialCases(str string) string {
	...
	terms := strings.FieldsSeq(str)

	for item := range terms {
