"""
Fetch SocArXiv papers from the past 24 hours into SQLite.
Usage:
  python socarxiv.py --db socarxiv.sqlite
  python socarxiv.py --db socarxiv.sqlite --query "social inequality"
  python socarxiv.py --db socarxiv.sqlite --hours 24 --max-results 500
"""
...
def main() -> int:
    ...
    ap.add_argument("--db", default="socarxiv.sqlite", help="SQLite database path")
